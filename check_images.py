...
def main():
    ...
    results = get_pet_labels(image_dir=in_arg.dir)

    # Function that checks Pet Images in the results Dictionary using results
    check_creating_pet_image_labels(results_dic=results)
    ...
    classify_images(images_dir=in_arg.dir, results_dic=results, model=in_arg.arch)

    # Function that checks Results Dictionary using results
    check_classifying_images(results_dic=results)
    ...
    adjust_results4_isadog(results_dic=results, dogfile="data/dognames.txt")

    # Function that checks Results Dictionary for is-a-dog adjustment using results
    check_classifying_labels_as_dogs(results_dic=results)
    ...
    results_stats = calculates_results_stats(results_dic=results)

    # Function that checks Results Statistics Dictionary using results_stats
    check_calculating_results(results_dic=results, results_stats_dic=results_stats)
    ...
    print_results(
        results_dic=results,
        results_stats_dic=results_stats,
        model=in_arg.arch,
